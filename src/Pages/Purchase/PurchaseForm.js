        ...
        <div className='w-full mx-auto custom-shadow bg-[#e8eaec] pt-10 pb-10 px-10 rounded-lg'>
            ...
            <form onSubmit={handleSubmit(handleSubmitParam)}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="number" name="floating_total" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" value={part?.price * quantity} disabled
                        />
