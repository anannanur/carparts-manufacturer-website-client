...
const Home = () => {
    ...
    return (
        <div>
            ...
            {/* parts */}
            <h1 className='text-uppercase text-center text-primary text-4xl md:text-5xl mt-20 font-semibold custom-border-primary w-fit mx-auto pb-4'>Our Latest Parts</h1>
            ...
            <div className='bg-secondary pt-20 pb-40'>
                <h1 className='text-uppercase text-center text-white text-4xl md:text-5xl mt-20 font-semibold w-fit mx-auto pb-4 mb-5'>Frequently Asked Questions</h1>
