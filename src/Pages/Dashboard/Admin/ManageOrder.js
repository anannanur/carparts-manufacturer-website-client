...
const ManageOrder = () => {
    ...
    const { data: allorders, isLoading, refetch } = useQuery('allorders', () => fetch(`https://vast-journey-16295.herokuapp.com/orders`, {
        method: 'GET',
        headers: {
    ...
    const orderDelete = (id) => {
        ...
        fetch(`https://vast-journey-16295.herokuapp.com/order/${id}`, {
            method: 'DELETE',
            headers: {
