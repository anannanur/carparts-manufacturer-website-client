...
const Blog = () => {
    return (
        <div className='mx-16 md:mx-48'>
            ...
            <div className="shadow-lg my-10">
                <div>
                    <h1 className=" font-bold text-center text-xl md:2xl text-primary px-5">Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h1>
            ...
            <div className="shadow-lg my-10">
                <div>
                    <h1 className=" font-bold text-center text-2xl text-primary px-5">How will you improve the performance of a React Application??</h1>
                    <p className=" p-3 md:p-10 text-md md:text-xl">
            ...
            <div className="shadow-lg my-10">
                <div>
                    <h1 className=" font-bold text-center text-xl md:2xl text-primary px-5">You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h1>
                    <p className=" p-3 md:p-10 text-md md:text-xl">
            ...
            <div className="shadow-lg my-10">
                <div>
                    <h1 className=" font-bold text-center text-2xl text-primary">What is a unit test? Why should write unit tests??</h1>
                    <p className=" p-5 md:p-10 text-md md:text-xl">
