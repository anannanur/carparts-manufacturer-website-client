...
const Footer = () => {
    ...
    return (
            ...
            <footer className="bg-gradient-to-b from-primary to-secondary">
                <div className="py-24 grid grid-cols-2 gap-8 px-6 md:grid-cols-4">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase">CarParts.</h2>
                        <ul className="text-gray-200 ml-[-18px]">
                            {
                                user && (
                                    <>
                                        <li className="mb-4">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase">Help center</h2>
                        <ul className="text-gray-200 ml-[-18px]">
                            <li className="mb-4">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase">Download</h2>
                        <ul className="text-gray-200 ml-[-18px]">
                            <li className="mb-4">
                ...
                <div className="py-6 px-4 bg-black md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center">© 2022 <Link to="">CarParts</Link>. All Rights Reserved.
                    </span>
